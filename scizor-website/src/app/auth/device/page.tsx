...
const DeviceAuthPage: React.FC = () => {
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // After successful authentication, redirect to consent page
      if (authParams) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Create user token for all Google sign-ins
      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Sign In to Scizor Desktop
          </h1>
          <p className="text-lg text-gray-600">
            Complete authentication to authorize the desktop application
          </p>
        </div>
